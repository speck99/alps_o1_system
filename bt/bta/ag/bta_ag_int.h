...
/** M: Change timer from 2s to 10s. @{ */
// Some device may reconnect after 2 seconds and don't accept
// AG's connection request that cause connect fail.
#define BTA_AG_COLLISION_TIMEOUT_MS (10 * 1000) /* 2 seconds */
/** @} */
#endif
