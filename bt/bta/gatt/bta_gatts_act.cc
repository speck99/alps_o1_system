...
#include "mediatek/bta/include/bta_gatts_co.h"

namespace mediatek = ::vendor::mediatek::bluetooth::stack;
...
static bool bta_gatts_nv_srv_chg_cback(tGATTS_SRV_CHG_CMD cmd,
                                       tGATTS_SRV_CHG_REQ* p_req,
                                       tGATTS_SRV_CHG_RSP* p_rsp) {
  return mediatek::bta_gatts_co_srv_chg((tBTA_GATTS_SRV_CHG_CMD)cmd,
